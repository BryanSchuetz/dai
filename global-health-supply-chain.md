...
* [The Supplier Relationship Management (SRM) portal  ](https://smp.dai.com/)is a cloud-based platform that connects large-scale buyers to local micro, small, and medium-sized enterprises (MSMEs). Multinationals gain access to new markets and thousands of verified local suppliers, and can measure and report on their impact on the local economy. In turn, MSMEs gain access to business opportunities with large-scale buyers. 
