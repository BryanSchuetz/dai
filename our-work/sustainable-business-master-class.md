        ...
        <div class="columns">
            <div class="column">
                ...
                <div class="container" style="margin-bottom: 1rem; margin-top: 1rem;">
                    <h3 style="font-size: 1.3rem; font-weight: 700; margin-bottom: 1rem;">The next Masterclass will be announced soon.</h3>

                   <a href="https://confirmsubscription.com/h/r/ACFA156B7601F0CF2540EF23F30FEDED">Sign up to be the first to find out about upcoming Masterclasses.</a>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="content">
                            ...
                            <a class="is-capitalized card-footer-item site-buttons is primary" href="/uploads/Masterclass_brochure%200826.pdf">Download</a>
                            </footer>
                </div>
            </div>
        </div>
