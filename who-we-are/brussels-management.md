---
title: Brussels, Management Team
permalink: "/who-we-are/global-reach/brussels/contacts/management"
layout: node
redirect_from: 
---
...
{% assign contacts = site.contacts | sort: 'sort-order' | where: 'group', 'Brussels Management'%}
