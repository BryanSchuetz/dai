...
layout: node
summary: 'DAI’s leaders ensure that our passion for development is executed with the
  discipline of a business. They set the standards for a global workforce dedicated
...
<div class="column">
{%- for leader in leaders offset:4 limit:3 -%}
{%- unless leader.published == false -%}
<a class="bulma-card" href="{{leader.url}}">
<div class="card is-child">
<div class="card-image">
...
{%- endfor -%}
  ...
  <div class="column">
    {%- for leader in leaders offset:7 limit:3 -%}
    {%- unless leader.published == false -%}
  <a class="bulma-card" href="{{leader.url}}">
    <div class="card is-child">
      <div class="card-image">
