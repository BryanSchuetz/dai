...
<div class="bulma enterprise-innovation">
  <div class="tile is-ancestor">
    <div class="is-parent tile is-4">
      <div class="tile box is-child" style="background-image: url(/uploads/Jalin-web-page.jpg); background-size: cover; background-position: center; min-height: 15rem;">
        <article>
        </article>
      </div>
    </div>
    <div class="tile is-parent">
      <div class="tile box is-child">
        <article>
          <p><strong>Jalin</strong></p>
          <p>Each year, thousands of women still die from childbirth and pregnancy complications in Indonesia. USAID’s <a href="https://www.dai.com/our-work/projects/indonesia-jalin">Jalin project</a> aimed to reduce maternal and newborn mortality by developing 26 co-created and context-specific interventions to boost antenatal and birthing care. Jalin worked closely with a variety of stakeholders in national and sub-national government entities, the private sector, and healthcare providers to develop 26 local solutions. Solutions included a floating ambulance service or free counselling and information on accessing antenatal care for women at supermarkets. A partnership with a U.S. fashion company also helped expand maternal and newborn health in the workplace in selected factories. The program supported more than 5,600 women to give birth, resuscitated 170 newborns who were not breathing at birth, and provided nearly 3,700 infants with postnatal care. </p>
        </article>
      </div>
    </div>
  </div>
  <div class="tile is-ancestor">
    <div class="is-parent tile">
      <div class="tile box is-child">
        <article>
          <p><strong>Promote: Women in the Economy (WIE)</strong></p>
          <p>For decades, women in Afghanistan have faced severe gender inequities, including exclusion from the workforce and limited access to maternal healthcare. To foster gender equality and women’s participation in the workplace, USAID’s WIE project supported Afghan women with industry specific business skills. The project supported 25 home-based midwife hubs to teach women basic business skills, ensuring their midwifery was sustainable. WIE also partnered with the Afghanistan Medical Council to officially accredit female doctors and dentists, who were previously unlicensed.</p>
        </article>
      </div>
    </div>
    <div class="tile is-parent is-4">
      <div class="tile box is-child" style="background-image: url(https://assetify-dai.com/projects/CTJ_Project_page_image.jpg); background-size: cover; background-position: center; min-height: 15rem;">
        <article>
        </article>
      </div>
    </div>
