...
summary: We envision better health systems that foster quality and access, reduce
  threats, and promote healthier behaviors to improve lives globally.
solutions:
- Global Health
hero: true
layout: solution
...
**We specialize in designing innovative, evidence-based technical programs that impact vulnerable young girls, pregnant women, infants and children, parents and carers, youth, refugees, and people living in conflict-affected areas.**
...
* **Trigger, nudge, and sustain behavior change:**  Using a people-centered approach and drawing on a range of behavioral economics and nudge theories, we design participatory behavior change projects. Our target groups include carers, youth, or health professionals, and our projects employ tactics like gamification or digital dialogue to help individuals change behavior around food, contraception, substance abuse, hand washing, providing respectful care, etc.
* **Demand Creation:** within wider program contexts, we create demand for health services or health-related products using social marketing techniques and other approaches informed by behavioral insights. 
* **Research & Analysis:** We conduct primary field research, surveys, and deep-dive data analysis to help our clients and host governments understand where and for whom inequities exist. Unpacking inequity clustering, particularly amongst the most vulnerable, allows us to apply these insights and support our clients in designing systems and programs to help those most in need.