...
gulp.task('build', shell.task([
  'JEKYLL_ENV=prod bundle exec jekyll build --incremental'
]))
...
gulp.task('aggregate', shell.task([
  'curl http://dai-global-developments.com/pubs.yml --output _data/pubs.yml && curl http://dai-global-digital.com/digital.yml --output _data/digital.yml && curl http://beta-corp.surge.sh/economic-growth.yml --output _data/economic-growth.yml'
]))
