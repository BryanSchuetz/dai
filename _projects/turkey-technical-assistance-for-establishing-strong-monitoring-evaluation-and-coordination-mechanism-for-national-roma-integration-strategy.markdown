...
The EuropeAid project, Technical Assistance for Establishing Strong Monitoring, Evaluation and Coordination Mechanism for National Roma Integration Strategy (for the Action Plans), led by WYG partnered with DAI’s Human Dynamics, aims to achieve measurable progress in Turkey towards the full enjoyment of all fundamental rights and freedoms by all individuals without discrimination in the area of Roma rights and strengthening respect for fundamental rights and freedoms for all individuals without discrimination in line with the European Court of Human Rights.
