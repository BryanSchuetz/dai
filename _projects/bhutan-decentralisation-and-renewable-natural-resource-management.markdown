...
summary: 'This work supports the implementation of the European Union (EU)-bilateral
  development cooperation strategy in Bhutan, with particular focus on the two ongoing
  EU budget support programmes: 1), Rural Development and Climate Change and 2), Local
  Governance and Fiscal Decentralisation. '
start: 2019
end: 2021
...
This project supports the implementation of the European Union (EU)-bilateral development cooperation strategy in Bhutan, with particular focus on the two ongoing EU budget support programmes: 1), Rural Development and Climate Change and 2), Local Governance and Fiscal Decentralisation.
