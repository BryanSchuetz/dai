...
2. Evidence-based prioritization of integrated nutrition project response and monitoring
...
* Delivered a [training of trainers package](/uploads/Nutrition%20Integration%20ToT%20Training%20Guide_FINAL_Feb%202026.pdf) to FCDO partner organizations and government staff in Somalia to strengthen nutrition service delivery within health systems.   
* Developed internal guidance for FCDO on the prevention and treatment of child wasting.
* Strengthened the use of nutrition information systems and synthezised multi-country lessons into a [learning brief](/uploads/NASC_NIS%20learning%20brief_06.02.26_Final.pdf) and [scoping matrix](/uploads/NASC_Annex%203_NIS%20scoping%20matrix_Feb%202026.xlsx) to inform decision-making. 
* Tracked FCDO nutrition investment and scored projects against the NPM for accountability.

## Select results

* Developed and launched [Unlocking Climate Finance for Nutrition: A Tool for Country Action](https://scalingupnutrition.org/resource-library/toolkits-tools/unlocking-climate-finance-nutrition-tool-country-action), equipping countries to move from policy commitments to financing readiness and Increased country readiness to access climate finance for nutrition, through sequenced [global](https://scalingupnutrition.org/events/webinar/webinar-navigating-climate-finance-nutrition-insights-tools-and-opportunities) and [peer-to-peer](https://scalingupnutrition.org/events/webinar/webinar-positioning-nutrition-access-climate-finance-lessons-bangladesh-and) webinars (over 300 participants). 
* Improved application of the NPM, increasing project scoring from 52% (2022) to 84% (2025).
* Strengthened FCDO’s advocacy capacity for nutrition integration into primary health care and the Universal Health Coverage agenda with a [framing paper](/uploads/NASC%20Framing%20Paper_Nutrition_UHC_Oct2024-785b6e.pdf) and a [case study](/uploads/NASC_Entry%20Points%20for%20Nutrition%20Integration%20in%20Primary%20Health%20Care%20Systems%20-%20Lessons%20from%20Nigeria%20and%20Pakistan%20Case%20Study_Feb%2026.pdf) featuring insights from Nigeria and Pakistan.
* Provided analysis and recommendations for improving women’s and children’s nutritional outcomes in Afghanistan, producing a [report](/uploads/Afghanistan%20Prioritising%20Nutritional%20Outcomes%20for%20Women%20and%20Girls_%20NASC2_Dec%202025.pdf) and two accompanying policy briefs:  (1) [funding priorities for malnutrition response](https://dai-assets.s3.amazonaws.com/our-work/Brief%202%20-%20Nutritional%20Outcomes%20Funding%20Cuts_Sept%202025.pdf) and (2) [the impact of restrictions on women and girls on their nutritional outcomes](https://dai-assets.s3.amazonaws.com/our-work/Brief%201%20-%20Nutritional%20Outcomes%20Women%20%20Girls_Sept%202025.pdf). This work supported a consensus-driven, multi-sectoral prioritization of nutrition and food security through the Food Security and Nutrition Dialogue Series, informing both the London Compact and FCDO portfolio decisions.
