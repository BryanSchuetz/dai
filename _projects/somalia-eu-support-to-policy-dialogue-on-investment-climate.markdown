...
The EU Support to Policy Dialogue on Investment Climate in Somalia project is enhancing the investment climate and business environment by improving access to finance, markets, and essential services for medium, small, and micro enterprises (MSMEs). 
