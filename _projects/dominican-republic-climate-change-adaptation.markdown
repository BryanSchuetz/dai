...
* Prepare a disaster risk and climate change vulnerability assessment, analyzing existing practices, disaster and resource management mechanisms, and social protection programs that need to evolve or be modified.
* Identify and prioritize strategies to reduce vulnerability and define a proposal for a program of activities that will initiate the structuring of a Territorial Adaptation Plan for the basin in the face of climate change and disaster management, prioritizing integrated water resources management and adaptive social protection.