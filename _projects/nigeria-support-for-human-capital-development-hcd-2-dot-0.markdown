...
* Strengthen multistakeholder platforms through advocacy visits and regional town halls to improve HCD outcomes.
* Coordinate evidence-based campaigns.
* Deliver tailored capacity-building for state focal persons.
* Promote the use of high-quality HCD data for policy making.
* Drive domestic resource mobilization to scale initiatives and innovations, particularly through engagement with the Private Sector Partners Group.
