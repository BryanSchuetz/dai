...
Additionally, DAI Global Health Vice President and Chief Technology Officer [Bobby Jefferson](https://www.dai.com/who-we-are/our-team/bobby-jefferson) and IntraHealth's Wayan Vota are presenting at the conference on a panel, “The State of Digital Health in International Development,” as part of a break out session which includes an IntraHealth employee. Susan Scribner, Greg Maly and Rob Salerno are facilitating workshop on “Outbreak Preparedness and Response Planning: The Critical Role of Communication” are presenting also at the Triangle (just confirming what they will be speaking on). We should mention this also in our news piece.
 
IntraHealth are also doing a fair amount – they are on the programme – not sure how we want to profile them?
 
I’d like to send out a targeted email on this also to our health mailing list and link to the news page. However I would use Mailchimp. Can you help me with some suggestions/tips on branding the template so it fits with DAI typical emails?
