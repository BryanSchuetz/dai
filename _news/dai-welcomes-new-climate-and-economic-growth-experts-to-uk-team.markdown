...
Kate Hargreaves’ 20-year career spans social accountability and transparency, public financial management, and global health; her recent focus has been on climate changes and renewable energy. She is passionate about accelerating green economic growth, which includes promoting the role of women in solar energy, localizing development by incorporating citizen voice and demand, and building community resilience to weather-related shocks.

“I’m a keen advocate for achieving Net Zero, which is crucial for successful global development and long-term economic growth. Locally led development that includes women and other disadvantaged groups is also key to this transition to renewable energy. DAI is in a great position to help achieve this through our work providing technical assistance and finding and facilitating practical climate and environmental adaptations."    
